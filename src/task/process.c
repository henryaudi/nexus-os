...
void *process_malloc(struct process *process, size_t size)
{
    ...
    int res =
        paging_map_to(process->task->page_directory, ptr, ptr, paging_align_address(ptr + size),
...
int process_terminate(struct process *process)
{
    ...
    /* Remove the process pointer from the processes array */
...
int process_map_binary(struct process *process)
{
    ...
    paging_map_to(process->task->page_directory, (void *)NEXUS_PROGRAM_VIRTUAL_ADDRESS,
